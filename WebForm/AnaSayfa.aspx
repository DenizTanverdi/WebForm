<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="WebForm.AnaSayfa" %>
        ...
        <div class="content">
			...
			<div id="jquery-accordion-menu" class="jquery-accordion-menu">
				...
				<ul>
					...
					<li><a href="#"><i class="fa fa-file-image-o"></i>Gallery </a><span class="jquery-accordion-menu-label">5 </span></li>
